...
TKIT.ContextMenu.createMenu = function () {
  for (var i = 0; i < TKIT.ContextMenu.items.length; i += 1) {
    (function (iter) {
      var item = TKIT.ContextMenu.items[iter];
      setTimeout(function () {
...
TKIT.ContextMenu.destroy = function () {
  ...
  if (TKIT.ContextMenu.active) {
    ...
    for (var i = 0; i < TKIT.ContextMenu.objects.length; i += 1) {
...
TKIT.scenes.generate = function (_type) {
  var type = _type;
